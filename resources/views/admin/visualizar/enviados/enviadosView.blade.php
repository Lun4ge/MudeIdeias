...
<div class="col-8"> 
  <table class="table" style="">
      ...
      <tbody>
          ...
          <tr>
              <th scope="row" style="background-color: #cccccc;">
                <button style="width: 100%;height:100%;background-color: #cccccc;border:none;outline:none;color:#404040;padding-left:2%;"
                 onclick="if(getElementById('enviado{{$item->id}}').style.display=='block'){
                  document.getElementById('enviado{{$item->id}}').style.display='none'}else{
                    document.getElementById('enviado{{$item->id}}').style.display='block'}">
        ...
        <tr scope="row" id="enviado{{$item->id}}" style="display:none;background-color:#f5f5f5;">
          <th>
            <div class="row">
               <div class="col-6">
